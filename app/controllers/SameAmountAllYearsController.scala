...
class SameAmountAllYearsController @Inject()(
                                         ...
                                         formProvider: SameAmountAllYearsFormProvider,
                                         val controllerComponents: MessagesControllerComponents,
                                         view: SameAmountAllYearsView
  ...
  def onPageLoad(mode: Mode): Action[AnyContent] = (identify andThen getData andThen requireData) {
    implicit request =>
      ...
      val preparedForm = request.userAnswers.get(SameAmountAllYearsPage) match {
        case None => form
