...
class ConfirmAddressControllerSpec extends SpecBase {
  ...
  lazy val confirmAddressRoute = routes.ConfirmAddressController.onPageLoad(NormalMode).url
  ...
  "ConfirmAddress Controller" must {
    ...
    "populate the view correctly on a GET when the question has previously been answered" in {
      ...
      val userAnswers = UserAnswers(userAnswersId, Json.obj(ConfirmAddressPage.toString -> JsBoolean(true)))
