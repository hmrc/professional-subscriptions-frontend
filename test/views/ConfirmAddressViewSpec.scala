...
class ConfirmAddressViewSpec extends YesNoViewBehaviours {
  ...
  val messageKeyPrefix = "confirmAddress"

  val form = new ConfirmAddressFormProvider()()

  "ConfirmAddress view" must {
    ...
    behave like yesNoPage(form, applyView, messageKeyPrefix, routes.ConfirmAddressController.onSubmit(NormalMode).url)
  }
}
