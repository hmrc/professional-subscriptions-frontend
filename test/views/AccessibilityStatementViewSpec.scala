...
class AccessibilityStatementViewSpec extends ViewBehaviours {
  ...
  "AccessibilityStatement view" must {
    ...
    val expectedGuidanceKeys = Seq(
      ...
      "accessibilityStatement.technicalInformationAboutThisServicesAccessibility.nonCompliant.listItem1",
      "accessibilityStatement.technicalInformationAboutThisServicesAccessibility.nonCompliant.listItem2",
